...
export default function PlatformsSection() {
  return (
    <section id="platforms" className="py-20 px-4 sm:px-6 lg:px-8 bg-card">
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-overlay">
                ...
                <button
                  disabled
                  className="w-full py-2.5 rounded-lg text-xs font-semibold text-muted-foreground border border-border cursor-not-allowed"
                >
                  Coming Soon
                </button>
              </div>
